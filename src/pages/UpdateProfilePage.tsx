...
export function UpdateProfilePage() {
  ...
  const update = (key: "fullName" | "phone", value: string) =>
  ...
  useEffect(() => {
    authFetch(`${apiBase}/api/v1/admin/profile/`)
      .then(async (response) => {
        ...
        if (!response.ok)
          throw new Error(
            body?.message || body?.detail || "Unable to load your profile.",
          );
    ...
    <div className="profile-page edit-profile-page">
      ...
      <div className="page-heading profile-heading">
        <div>
          ...
          <p className="muted">Keep your account information up to date.</p>
        </div>
      </div>
      <form className="edit-profile-card" onSubmit={handleSubmit}>
        <div className="form-section">
          <div className="section-title">
            <h2>Profile image</h2>
            <p>Choose a clear image for your account.</p>
          </div>
          <div className="upload-row">
            ...
            <div>
              ...
              <p className="helper-text">JPG, PNG or GIF. Maximum size 2MB.</p>
            </div>
          </div>
        </div>
        <div className="form-section">
